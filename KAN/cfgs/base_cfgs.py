...
class Cfgs(PATH):
    def __init__(self):
        ...
        # top objects of each image label
        self.TOP_OBJ = 5

        # Max length of fact sentences
        self.FACT_TOKEN = 7

        # top relations of objects
        self.TOP_REL = 2
        ...
        self.LR_BASE = 0.00008

        # Learning rate decay ratio
        self.LR_DECAY_R = 0.15

        # Learning rate decay at {x, y, z...} epoch
        self.LR_DECAY_LIST = [10, 12, 14]
